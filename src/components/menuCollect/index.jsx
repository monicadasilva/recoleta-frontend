import { Container, ContentInput, ContentTypesCollect, Footer, Main, LineExit } from "./style";
...
export const MenuCollect = ( { open }) => {

  const { SetMenuColletc, SetMenuDown } = useMenu()

  return (
    <> {open && 
      <Container>
        <LineExit onClick={() => (SetMenuColletc(false), SetMenuDown(true))}/>
        <ContentInput>
